...
router.get('/deadlines/upcoming', publicCache, complianceController.getUpcomingDeadlines);
router.get('/deadlines', publicCache, validate(complianceQuerySchema), complianceController.getComplianceDeadlines);
// Admin writes
...
router.get('/documents', publicCache, validate(complianceQuerySchema), complianceController.getComplianceDocuments);
// Admin writes
...
router.get('/stats', publicCache, complianceController.getComplianceStats);
